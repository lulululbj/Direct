...
import luyao.ktx.R;
import luyao.ktx.ext.ViewExtKt;
...
public class AvatarImageView extends AppCompatImageView {
    ...
    private static final int DEFAULT_BOARDER_COLOR = Color.parseColor("#00BE82");
    private static final int DEFAULT_BOARDER_WIDTH = (int) ViewExtKt.dp2px(2);
    ...
    private void refreshBitmapShaderConfig(Bitmap bitmap, boolean adjustScale) {
        ...
        if (adjustScale) {
            ...
            mMatrix.postTranslate(-(bitmapWidth * 1f / 2f - mRadius - getPaddingLeft()), -(bitmapHeight * 1f / 2f - mRadius - getPaddingTop()));
        }
    ...
    private void drawBoarder(Canvas canvas) {
        canvas.drawCircle(mCenterX, mCenterY, mRadius - mBoarderWidth / 2f, mPaintCircle);
    }
