...
class StarMenuFragment : BaseFragment(R.layout.fragment_common_menu) {
...
//                vm.search(MMKVConstants.starTag)
    ...
    override fun startObserve() {
        ...
        vm.run {
            starResult.observe(viewLifecycleOwner) {
                YLog.e("receive star")
                submitEngineList(it.data, MMKVConstants.engineSpanCount)
            }
