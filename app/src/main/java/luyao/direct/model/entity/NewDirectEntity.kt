 ...
 */
@Entity(tableName = "new_direct_entity")
@JsonClass(generateAdapter = true)
data class NewDirectEntity(
    @PrimaryKey
    @ColumnInfo(name = "id")
    var id: String, // 主键
    ...
    // 按 count 排序
    override fun compareTo(other: NewDirectEntity) = other.count - this.count
}